...
//}
//
//inline float Vec3::vec3_dot(Vec3 a, Vec3 b)
//{
//	return (a.x * b.x) + (a.y * b.y) + (a.z * b.z);
//}
//
//inline Vec3 Vec3::vec3_clone(Vec3* v)
//{
//	Vec3 result =
//	{
//		v->x,
...
//}
//
//inline Vec2 vec2_from_vec4(Vec4 v)
//{
//	Vec2 result =
//	{
//		v.x,
...
//}
//
//inline Vec4 vec4_from_vec3(Vec3 v)
//{
//	Vec4 result =
//	{
//		v.x,
 ...
 struct vec3_t
{
	...
	//vec3_t operator*(const vec3_t& v) { return { x * v.x, y * v.y, z * v.z }; }
	//vec3_t operator/(const vec3_t& v) { return { x / v.x, y / v.y, z / v.z }; }
	//float dot(const vec3_t& v) { return x * v.x + y * v.y + z * v.z; }
